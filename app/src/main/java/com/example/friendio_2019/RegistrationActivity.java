...
public class RegistrationActivity extends AppCompatActivity{
    ...
    private void createProfileForAccount(String firstName, String lastName, String bio,
        ...
        Intent moveToMainApp = new Intent(RegistrationActivity.this, MainActivity.class);
        startActivity(moveToMainApp);
    }
                    ...
                    if (resultCode == RESULT_OK && data != null) {
                        ...
                        if (selectedImage != null) {
                            ...
                            if (cursor != null) {
                                ...
                                Log.d("dsd", picturePath);

                                try {
                                    Bitmap bm = BitmapFactory.decodeFile(picturePath);
                                    Log.d("asdd", bm.toString());
                                    ByteArrayOutputStream baos = new ByteArrayOutputStream();
                                    bm.compress(Bitmap.CompressFormat.JPEG, 100, baos);
                                    setEncodedImage(Base64.encodeToString(baos.toByteArray(), Base64.DEFAULT));
